...
echo <<< EOT
  ...
  <div class="container" id="platforms_results">
    <ul>
      <li><a href="#RNA_seq">RNA-seq</a></li>
      <li><a href="#Affy_U133Plus2">Affy U133Plus2</a></li>
    </ul>   

    <div class="container" id="RNA_seq"  >
        <ul>
          <li><a href="#Affy_U133Plus2_pca">PCA</a></li>
          <li><a href="#Affy_U133Plus2_purity">Tumour purity</a></li>
          <li><a href="#Affy_U133Plus2_expression_heatmap">Expression heatmap</a></li>
          <li><a href="#Affy_U133Plus2_expression_profiles">Expression profiles</a></li>
          <li><a href="#Affy_U133Plus2_co_expression_analysis">Expression correlations</a></li>
          <li><a href="#Affy_U133Plus2_gene_networks">Gene networks</a></li>
          
        </ul>    
        <div id="Affy_U133Plus2_pca">
          ...
          <iframe class='results' scrolling='no' src='$iframe_directory/Affy_U133Plus2/pca_2d_1.html'></iframe>
          <iframe class='results' scrolling='no' src='$iframe_directory/Affy_U133Plus2/pca_3d_1.html'></iframe>
          <iframe class='results' scrolling='no' src='$iframe_directory/Affy_U133Plus2/pca_bp_1.html'></iframe>
        </div>

        <div id="Affy_U133Plus2_purity">
          <div class='description'>
          ...
          <div class='estimate_container'>
            <iframe class='results' id='estimate' onload='resizeIframe(this)' scrolling='no' src='$iframe_directory/Affy_U133Plus2/estimate.html'></iframe>
          </div>
...
EOT;
        ...
        $target_io = fopen("$result_directory/Affy_U133Plus2/target.txt", "r");
        ...
        <div id="Affy_U133Plus2_expression_heatmap">
          <div class='description'>
          ...
          <iframe class='results' scrolling='no' src='$iframe_directory/Affy_U133Plus2/heatmap_exp_1.html'></iframe>
        </div>
   
        <div id="Affy_U133Plus2_expression_profiles">
            <div class='description'>
                <p class='pub_det'>The expression profile of selected gene(s) across comparative groups are presented as both summarised and a
            ...
            <!-- Calling Javascripts -->
            <script>LoadGeneSelector("gea_platforms_sel", "", "", "Affy_U133Plus2")</script>
            <script>LoadAnalysis("gea_platforms_sel","gea_platforms_run","platforms","","Affy_U133Plus2_gene_expression","0")</script>
        </div>            
    
        <div id="Affy_U133Plus2_co_expression_analysis">
          <div class='description'>
            <p class='pub_det'>
          ...
          <!-- Calling Javascripts -->
          <script>LoadGeneSelector("cea_platforms_sel", "", "", "Affy_U133Plus2")</script>
          <script>LoadAnalysis("cea_platforms_sel","cea_platforms_run","platforms","","Affy_U133Plus2_co_expression","1")</script>
        </div>
    
        <div id='Affy_U133Plus2_gene_networks'>
          <div class='description'>
            <p class='pub_det'>
...
EOT;
      ...
      echo <<< EOT
          ...
          <script>LoadGeneSelector('platforms_net_sel','','','Affy_U133Plus2')</script>
          <script>LoadAnalysis('platforms_net_sel','platforms_run_net','','','Affy_U133Plus2_gene_network','0')</script>
        </div>
    </div>
    
    <div class="container" id="Affy_U133Plus2"  >
        <ul>
          <li><a href="#Affy_U133Plus2_pca">PCA</a></li>
          <li><a href="#Affy_U133Plus2_purity">Tumour purity</a></li>
          <li><a href="#Affy_U133Plus2_expression_heatmap">Expression heatmap</a></li>
