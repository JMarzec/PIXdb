...
// importing variables
$iframe_directory = $relative_root_dir."pixdb_backoffice/data/platforms/Affy_HuEx1ST";
$result_directory = "$absolute_root_dir/pixdb_backoffice/data/platforms/Affy_HuEx1ST";
...
EOT;
    ...
    <div id="expression_profiles">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("gea_platforms_sel", "", "", "Affy_HuEx1ST")</script>
      <script>LoadAnalysis("gea_platforms_sel","gea_platforms_run","platforms","","Affy_HuEx1ST_gene_expression","0")</script>
    </div>
    ...
    <div id="co_expression_analysis">
        ...
        <!-- Calling Javascripts -->
        <script>LoadGeneSelector("cea_platforms_sel", "", "", "Affy_HuEx1ST")</script>
        <script>LoadAnalysis("cea_platforms_sel","cea_platforms_run","platforms","","Affy_HuEx1ST_co_expression","1")</script>
    </div>
...
EOT;
  ...
  echo <<< EOT
      ...
      <script>LoadGeneSelector('platforms_net_sel','','','Affy_HuEx1ST')</script>
      <script>LoadAnalysis('platforms_net_sel','platforms_run_net','','','Affy_HuEx1ST_gene_network','0')</script
    </div>
