...
EOT;
    ...
    <div id="expression_profiles">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("gea_platforms_sel", "", "", "Affy_U95Av2")</script>
      <script>LoadAnalysis("gea_platforms_sel","gea_platforms_run","platforms","","Affy_U95Av2_gene_expression","0")</script>
    </div>
