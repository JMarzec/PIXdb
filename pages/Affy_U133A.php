...
// importing variables
$iframe_directory = $relative_root_dir."pixdb_backoffice/data/platforms/Affy_U133A/";
$result_directory = "$absolute_root_dir/pixdb_backoffice/data/platforms/Affy_U133A/";
...
EOT;
    ...
    <div id="expression_profiles">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("gea_platforms_sel", "", "", "Affy_U133A")</script>
      <script>LoadAnalysis("gea_platforms_sel","gea_platforms_run","platforms","","Affy_U133A_gene_expression","0")</script>
    </div>
    ...
    <div id="co_expression_analysis">
        ...
        <!-- Calling Javascripts -->
        <script>LoadGeneSelector("cea_platforms_sel", "", "", "Affy_U133A")</script>
        <script>LoadAnalysis("cea_platforms_sel","cea_platforms_run","platforms","","Affy_U133A_co_expression","1")</script>
    </div>
...
EOT;
  ...
  echo <<< EOT
      ...
      <script>LoadGeneSelector('platforms_net_sel','','','Affy_U133A')</script>
      <script>LoadAnalysis('platforms_net_sel','platforms_run_net','','','Affy_U133A_gene_network','0')</script
    </div>
