...
add_trace( y = ~log2FC, marker = list( size=geneData.rank, color=geneData.rank, colorbar=list(title='Rank (%)'), colorscale='Viridis', cauto=FALSE, cmin=0, cmax=100, reversescale = FALSE, line = list(color = 'rgba(0, 0, 0, 0.4)', width = 1)), name = "log2 FC", text = paste0("P = ", geneData.combined_p), textposition = 'outside' )  %>%
