...
<!-- Transcriptomics landscape -->
  <center>
    <tr>
        <tr style='text-align:center'>
          <td>
            <h3> Transcriptomics landscape </h3>
          </td>
        </tr>
  ...
  <table id="sel_container">
    <tr>
        ...
        Genes were ranked according to the evidence for differential expression between biological groups presented on the graph.
        Individual <b>prostate cancer development and progressions</b> stage are linked with arrows and are indicated by numbers 1-5,
        which correspond to the cross-platform analysis results presented in the table and analytical modules below.
        <br><br>
  ...
  <br>
    ...
    <center>
        <tr>
            <h3> Cross-platform analysis results </h3>
        </tr>
    </center>
